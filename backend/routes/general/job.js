...
const { create, find, update, remove, findById,smartjobbyid,smartjobs,jobsbymahzorid,smartjobs2,smartjobs3,jobsbypopulation,jobbyjobcode} = require('../../controllers/general/job');
